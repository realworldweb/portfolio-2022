               ...
               <div className="bg-dark col-md-3 col-sm-6">
                    <div className={`color-white d-flex flex-column align-items-center ${Styles.serviceThumb}`}>
                         <SvgReact width="5rem" height="5rem" />
                              ...
                              <p className="color-white d-block position-relative text-center">knowledge of modern es6 Javascript, Typescript and best practices. Familar with frameworks such as react and tools such as next.js</p>
                    </div>
               </div>
